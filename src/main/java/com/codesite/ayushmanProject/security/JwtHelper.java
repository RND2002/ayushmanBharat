...
public class JwtHelper {
    ...
    private String doGenerateToken(Map<String, Object> claims, String subject) {
        LoginEntity user=loginRepository.findByEmailAddress(subject);
        return Jwts.builder().setClaims(claims).claim("roles", user.getRoles().toString()).setSubject(subject).setIssuedAt(new Date(System.currentTimeMillis()))
